...
from .loss import ClipLoss, DistillClipLoss, CoCaLoss, SigLipLoss, ClipKDLoss
...
def create_loss(args):
    distill_loss = getattr(args, 'distill_loss', None)
    if getattr(args, 'distill', False) and distill_loss == "clipkd":
        return ClipKDLoss(
            args,
    ...
    elif getattr(args, 'distill', False):
